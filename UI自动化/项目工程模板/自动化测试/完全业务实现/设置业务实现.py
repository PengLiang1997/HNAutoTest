...
class 版次管理工作区(page):
    ...
    def 新增版次界面版次节点管理(self):
        ...
        #空值
        self.click(设置页对象库.版次管理工作区.保存版次节点)
        if not self.wait(公共元素对象库.系统提示信息弹框.format("请输入长度为一位的字母"),3):
            raise AssertionError("版次节点为空时，点击保存版次节点，没有查看到提示信息")
        #超长
        self.send_keys(设置页对象库.版次管理工作区.版次内容输入框, "123456789012345678901234567890123456789012345612345678907890")
        self.click(设置页对象库.版次管理工作区.保存版次节点)
        if not self.wait(公共元素对象库.系统提示信息弹框.format("请输入长度为一位的字母"), 3):
            raise AssertionError("版次节点名称超长时，点击保存版次节点，没有查看到提示信息")
        #重名
...
class 属性管理工作区(page):
    ...
    def 新增属性系统(self):
        ...
        #超长
        self.send_keys(设置页对象库.属性管理工作区.属性系统名称输入框,"123456789012345678901234567890123456789012345612345678907890")
        self.click(设置页对象库.属性管理工作区.属性系统保存按钮)
        if not self.wait(公共元素对象库.系统提示信息弹框.format("操作失败"),3):
            raise AssertionError("属性系统名称超长时，点击保存，未出现属性系统名称超长的提示信息")
        #重名
    ...
    def 属性系统添加属性(self):
        ...
        self.send_keys(设置页对象库.属性管理工作区.属性类别输入框.format("1"),'123456789012345678901234567890123456789012345612345678907890')
        self.send_keys(设置页对象库.属性管理工作区.属性名称输入框.format("1"), '123456789012345678901234567890123456789012345612345678907890')
        self.click(设置页对象库.属性管理工作区.行保存按钮.format("1"))
        if not self.wait(公共元素对象库.系统提示信息弹框.format("操作失败"),3):
    ...
    def 导入属性模板(self):
        ...
        if not self.wait(公共元素对象库.系统提示信息弹框.format("Excel中存在为空的属性类别、属性名称！"),3):
    ...
    def 删除单个属性(self):
        ...
        self.属性管理页面.创建属性系统(属性系统名称="test")
        self.click(设置页对象库.属性管理工作区.属性系统名称.format("test"))
        self.属性管理页面.添加属性(属性类型="A",属性名称="A")
    ...
    def 批量删除属性(self):
        ...
        self.click(设置页对象库.属性管理工作区.属性系统名称.format("test"))
        self.属性管理页面.添加属性(属性类型="A", 属性名称="A")
        self.属性管理页面.添加属性(属性类型="B", 属性名称="B")
        self.属性管理页面.添加属性(属性类型="C", 属性名称="C")
